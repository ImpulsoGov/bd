...
AS WITH dados_anonimizados_demo_vicosa AS (
         SELECT res.estabelecimento_cnes,
           ...
           FROM ( SELECT row_number() OVER (PARTITION BY 0::integer) AS seq,
                   ...
                   FROM dados_nominais_mg_vicosa.lista_nominal_gestantes) res
 ...
 SELECT tb1.municipio_id_sus,
    ...
    impulso_previne_dados_nominais.equipe_ine(tb1.municipio_id_sus::text, tb1.equipe_ine::text) AS equipe_ine,
    tb1.equipe_nome,
    tb1.acs_nome,
