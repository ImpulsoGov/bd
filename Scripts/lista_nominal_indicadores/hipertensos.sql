SELECT
   ...
   FROM ( SELECT row_number() OVER (PARTITION BY tfcp.no_cidadao, tdt.dt_registro ORDER BY tfcp.no_cidadao DESC) AS r,
            ( SELECT tempo.dt_registro
                   FROM esus_5213087_minacu_go_20220921.tb_fat_proced_atend_proced fichaproced
                     JOIN esus_5213087_minacu_go_20220921.tb_dim_procedimento proced ON fichaproced.co_dim_procedimento = proced.co_seq_dim_procedimento
                     JOIN esus_5213087_minacu_go_20220921.tb_dim_tempo tempo ON fichaproced.co_dim_tempo = tempo.co_seq_dim_tempo
                     JOIN esus_5213087_minacu_go_20220921.tb_dim_cbo cbo ON fichaproced.co_dim_cbo = cbo.co_seq_dim_cbo AND (cbo.nu_cbo::text ~~ ANY (ARRAY['2251%'::text, '2252%'::text, '2253%'::text, '2231%'::text, '2235%'::text, '3222%'::text]))
            ...
            ( SELECT max(tempo.dt_registro) AS max
                   FROM esus_5213087_minacu_go_20220921.tb_fat_atendimento_individual atendimento
                     JOIN esus_5213087_minacu_go_20220921.tb_dim_tempo tempo ON atendimento.co_dim_tempo = tempo.co_seq_dim_tempo
                     JOIN esus_5213087_minacu_go_20220921.tb_fat_atd_ind_problemas problemas ON atendimento.co_seq_fat_atd_ind = problemas.co_fat_atd_ind
                     JOIN esus_5213087_minacu_go_20220921.tb_dim_cbo cbo ON problemas.co_dim_cbo_1 = cbo.co_seq_dim_cbo AND (cbo.nu_cbo::text ~~ ANY (ARRAY['2251%'::text, '2252%'::text, '2253%'::text, '2231%'::text, '2235%'::text]))
                     LEFT JOIN esus_5213087_minacu_go_20220921.tb_dim_ciap ciap ON problemas.co_dim_ciap = ciap.co_seq_dim_ciap AND (ciap.nu_ciap::text = ANY (ARRAY['K86'::character varying::text, 'K87'::character varying::text]))
                     LEFT JOIN esus_5213087_minacu_go_20220921.tb_dim_cid cid ON problemas.co_dim_cid = cid.co_seq_dim_cid AND (cid.nu_cid::text = ANY (ARRAY['I10'::character varying::text, 'I11'::character varying::text, 'I110'::character varying::text, 'I119'::character varying::text, 'I12'::character varying::text, 'I120'::character varying::text, 'I129'::character varying::text, 'I13'::character varying::text, 'I130'::character varying::text, 'I131'::character varying::text, 'I132'::character varying::text, 'I139'::character varying::text, 'I15'::character varying::text, 'I150'::character varying::text, 'I151'::character varying::text, 'I152'::character varying::text, 'I158'::character varying::text, 'I159'::character varying::text, 'O10'::character varying::text, 'O100'::character varying::text, 'O101'::character varying::text, 'O102'::character varying::text, 'O103'::character varying::text, 'O104'::character varying::text, 'O109'::character varying::text, 'O11'::character varying::text]))
                  WHERE atendimento.co_fat_cidadao_pec = tfcp.co_seq_fat_cidadao_pec) AS dt_consulta_mais_recente,
            ...
            (( SELECT cadastro.st_hipertensao_arterial
                   FROM esus_5213087_minacu_go_20220921.tb_fat_cad_individual cadastro
                     JOIN esus_5213087_minacu_go_20220921.tb_dim_tempo tempo ON cadastro.co_dim_tempo = tempo.co_seq_dim_tempo
                  WHERE cadastro.co_fat_cidadao_pec = tfcp.co_seq_fat_cidadao_pec
                  ORDER BY cadastro.co_dim_tempo DESC
            ...
            (( SELECT count(*) AS count
                   FROM esus_5213087_minacu_go_20220921.tb_fat_atendimento_individual atendimento
                     ...
                     LEFT JOIN esus_5213087_minacu_go_20220921.tb_dim_ciap ciap ON problemas.co_dim_ciap = ciap.co_seq_dim_ciap AND (ciap.nu_ciap::text = ANY (ARRAY['K86'::character varying::text, 'K87'::character varying::text]))
                     LEFT JOIN esus_5213087_minacu_go_20220921.tb_dim_cid cid ON problemas.co_dim_cid = cid.co_seq_dim_cid AND (cid.nu_cid::text = ANY (ARRAY['I10'::character varying::text, 'I11'::character varying::text, 'I110'::character varying::text, 'I119'::character varying::text, 'I12'::character varying::text, 'I120'::character varying::text, 'I129'::character varying::text, 'I13'::character varying::text, 'I130'::character varying::text, 'I131'::character varying::text, 'I132'::character varying::text, 'I139'::character varying::text, 'I15'::character varying::text, 'I150'::character varying::text, 'I151'::character varying::text, 'I152'::character varying::text, 'I158'::character varying::text, 'I159'::character varying::text, 'O10'::character varying::text, 'O100'::character varying::text, 'O101'::character varying::text, 'O102'::character varying::text, 'O103'::character varying::text, 'O104'::character varying::text, 'O109'::character varying::text, 'O11'::character varying::text]))
                  WHERE atendimento.co_fat_cidadao_pec = tfcp.co_seq_fat_cidadao_pec)) > 0 AS possui_hipertensao_diagnosticada,
            ( SELECT max(tempo.dt_registro) AS max
                   FROM esus_5213087_minacu_go_20220921.tb_fat_cad_individual cadastro
                     JOIN esus_5213087_minacu_go_20220921.tb_dim_tempo tempo ON cadastro.co_dim_tempo = tempo.co_seq_dim_tempo
           ...
           FROM esus_5213087_minacu_go_20220921.tb_fat_cidadao_pec tfcp
             JOIN esus_5213087_minacu_go_20220921.tb_dim_tempo tdt ON tfcp.co_dim_tempo_nascimento = tdt.co_seq_dim_tempo
             JOIN esus_5213087_minacu_go_20220921.tb_dim_identidade_genero tidg ON tfcp.co_dim_identidade_genero = tidg.co_seq_dim_identidade_genero
             JOIN esus_5213087_minacu_go_20220921.tb_dim_sexo tds ON tfcp.co_dim_sexo = tds.co_seq_dim_sexo
             LEFT JOIN esus_5213087_minacu_go_20220921.tb_fat_cad_individual tfcirecente ON tfcirecente.co_seq_fat_cad_individual = (( SELECT cadastroindividual.co_seq_fat_cad_individual
                   FROM esus_5213087_minacu_go_20220921.tb_fat_cad_individual cadastroindividual
                  WHERE (cadastroindividual.co_fat_cidadao_pec IN ( SELECT tfccadastro.co_seq_fat_cidadao_pec
                           FROM esus_5213087_minacu_go_20220921.tb_fat_cidadao_pec tfccadastro
                 ...
                 LIMIT 1))
             LEFT JOIN esus_5213087_minacu_go_20220921.tb_fat_atendimento_individual tfairecente ON tfairecente.co_seq_fat_atd_ind = (( SELECT atendimentoindividual.co_seq_fat_atd_ind
                   FROM esus_5213087_minacu_go_20220921.tb_fat_atendimento_individual atendimentoindividual
                  WHERE (atendimentoindividual.co_fat_cidadao_pec IN ( SELECT tfcatendimento.co_seq_fat_cidadao_pec
                           FROM esus_5213087_minacu_go_20220921.tb_fat_cidadao_pec tfcatendimento
                 ...
                 LIMIT 1))
             LEFT JOIN esus_5213087_minacu_go_20220921.tb_fat_visita_domiciliar tfvdrecente ON tfvdrecente.co_seq_fat_visita_domiciliar = (( SELECT visitadomiciliar.co_seq_fat_visita_domiciliar
                   FROM esus_5213087_minacu_go_20220921.tb_fat_visita_domiciliar visitadomiciliar
                  WHERE (visitadomiciliar.co_fat_cidadao_pec IN ( SELECT tfcvisita.co_seq_fat_cidadao_pec
                           FROM esus_5213087_minacu_go_20220921.tb_fat_cidadao_pec tfcvisita
                 ...
                 LIMIT 1))
             LEFT JOIN esus_5213087_minacu_go_20220921.tb_dim_equipe equipeatendimentorecente ON equipeatendimentorecente.co_seq_dim_equipe = tfairecente.co_dim_equipe_1
             LEFT JOIN esus_5213087_minacu_go_20220921.tb_dim_equipe equipeacadastrorecente ON equipeacadastrorecente.co_seq_dim_equipe = tfcirecente.co_dim_equipe
             LEFT JOIN esus_5213087_minacu_go_20220921.tb_fat_cidadao_territorio cidadaoterritoriorecente ON cidadaoterritoriorecente.co_fat_cad_individual = tfcirecente.co_seq_fat_cad_individual
             LEFT JOIN esus_5213087_minacu_go_20220921.tb_dim_unidade_saude unidadeatendimentorecente ON unidadeatendimentorecente.co_seq_dim_unidade_saude = tfairecente.co_dim_unidade_saude_1
             LEFT JOIN esus_5213087_minacu_go_20220921.tb_dim_unidade_saude unidadecadastrorecente ON unidadecadastrorecente.co_seq_dim_unidade_saude = tfcirecente.co_dim_unidade_saude
             LEFT JOIN esus_5213087_minacu_go_20220921.tb_dim_profissional acsvisitarecente ON acsvisitarecente.co_seq_dim_profissional = tfvdrecente.co_dim_profissional
             LEFT JOIN esus_5213087_minacu_go_20220921.tb_dim_profissional acscadastrorecente ON acscadastrorecente.co_seq_dim_profissional = tfcirecente.co_dim_profissional
             LEFT JOIN esus_5213087_minacu_go_20220921.tb_dim_tempo acstempovisitarecente ON tfvdrecente.co_dim_tempo = acstempovisitarecente.co_seq_dim_tempo
          ORDER BY tfcp.no_cidadao) v1
  WHERE (v1.possui_hipertensao_diagnosticada OR v1.possui_hipertensao_autoreferida) AND v1.r = 1 AND v1.st_mudou_se = 0 AND v1.se_faleceu = 0