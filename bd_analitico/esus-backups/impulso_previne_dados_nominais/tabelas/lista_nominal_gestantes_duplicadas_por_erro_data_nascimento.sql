-- impulso_previne_dados_nominais.lista_nominal_gestantes_duplicadas_por_erro_data_nascimento definition

-- Drop table

-- DROP TABLE impulso_previne_dados_nominais.lista_nominal_gestantes_duplicadas_por_erro_data_nascimento;

CREATE TABLE impulso_previne_dados_nominais.lista_nominal_gestantes_duplicadas_por_erro_data_nascimento (
