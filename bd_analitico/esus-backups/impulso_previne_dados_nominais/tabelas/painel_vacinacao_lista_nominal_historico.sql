-- impulso_previne_dados_nominais.painel_vacinacao_lista_nominal_historico definition

-- Drop table

-- DROP TABLE impulso_previne_dados_nominais.painel_vacinacao_lista_nominal_historico;

CREATE TABLE impulso_previne_dados_nominais.painel_vacinacao_lista_nominal_historico (
