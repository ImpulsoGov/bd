...
CREATE MATERIALIZED VIEW impulso_previne_dados_nominais.painel_coordenadores_lista_nominal_gestantes
...
-- View indexes:
CREATE INDEX _painel_coordenadores_lista_nominal_gestantes_municipio_id_sus_ ON impulso_previne_dados_nominais.painel_coordenadores_lista_nominal_gestantes USING btree (municipio_id_sus);