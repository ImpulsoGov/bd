...
AS WITH dados_transmissoes_recentes AS (
         ...
         SELECT 
            ...
            max(GREATEST(dtr.dt_solicitacao_hemoglobina_glicada_mais_recente::date, dtr.dt_consulta_mais_recente, dtr.data_ultimo_cadastro, dtr.dt_ultima_consulta)) AS dt_registro_producao_mais_recente,
            min(LEAST(dtr.dt_solicitacao_hemoglobina_glicada_mais_recente::date, dtr.dt_consulta_mais_recente, dtr.data_ultimo_cadastro, dtr.dt_ultima_consulta)) AS dt_registro_producao_mais_antigo
    ...
    ,  tabela_final AS (
        ...
        LEFT JOIN data_registro_producao drp 
            ...
            SELECT 
                ...
                tf.consulta_e_solicitacao_hemoglobina_em_dia,
                tf.status_em_dia,
                tf.status_usuario,
                tf.identificacao_condicao_diabetes,
                ...
                tf.estabelecimento_cnes_cadastro,
                tf.estabelecimento_nome_atendimento,
                tf.estabelecimento_nome_cadastro,
                ...
                tf.possui_diabetes_autorreferida,
                tf.possui_diabetes_diagnosticada,
    ...
    SELECT
        ...
        ddv.realizou_solicitacao_hemoglobina_ultimos_6_meses,
        ...
        ddv.consulta_e_solicitacao_hemoglobina_em_dia,
        ddv.status_em_dia,
        ddv.status_usuario,
        ddv.identificacao_condicao_diabetes,
        ddv.cidadao_cpf,
        ...
        ddv.estabelecimento_cnes_cadastro,
        ddv.estabelecimento_nome_atendimento,
        ddv.estabelecimento_nome_cadastro,
        ...
        ddv.acs_nome_visita,
        ddv.possui_diabetes_autorreferida,
        ddv.possui_diabetes_diagnosticada,
