CREATE OR REPLACE PROCEDURE impulso_previne.sincronizar_tabelas_capitacao_ponderada_cadastro()
 LANGUAGE plpgsql
AS $procedure$
DECLARE
    tabela text;
BEGIN
    FOR tabela IN 
        ...
        and table_name like any (array['capitacao_ponderada_c%','caracterizacao_municipal_resumo%'])
    LOOP
	    SET ROLE postgres;
	   refresh materialized view impulso_previne.caracterizacao_municipal_resumo;
	   call impulso_previne.atualizar_views_capitacao_ponderada_cadastros();
