-- impulso_previne.monitoramento_area_logada definition

-- Drop table

-- DROP TABLE impulso_previne.monitoramento_area_logada;

CREATE TABLE impulso_previne.monitoramento_area_logada (
