-- impulso_previne.indicadores_desempenho_score_equipes_validas source

CREATE MATERIALIZED VIEW impulso_previne.indicadores_desempenho_score_equipes_validas
TABLESPACE pg_default
AS SELECT sub.municipio_id_ibge,
...
-- View indexes:
CREATE INDEX indicadores_desempenho_score_equipes_validas_municipio_id_sus_i ON impulso_previne.indicadores_desempenho_score_equipes_validas USING btree (municipio_id_sus, periodo_id, indicador_id);
CREATE INDEX indicadores_desempenho_score_equipes_validas_municipio_uf_idx ON impulso_previne.indicadores_desempenho_score_equipes_validas USING btree (municipio_uf, periodo_codigo, indicador_nome);