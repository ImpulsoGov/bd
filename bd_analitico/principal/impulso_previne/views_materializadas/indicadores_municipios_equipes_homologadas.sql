-- impulso_previne.indicadores_municipios_equipes_homologadas source

CREATE MATERIALIZED VIEW impulso_previne.indicadores_municipios_equipes_homologadas
...
AS SELECT p.data_inicio AS periodo_data_inicio,
   ...
   FROM dados_publicos.sisab_indicadores_municipios_equipes_homologadas tb1
