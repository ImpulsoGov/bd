-- impulso_previne.monitoramento_area_logada_usuarios_ativos_por_municipio_new source

CREATE MATERIALIZED VIEW impulso_previne.monitoramento_area_logada_usuarios_ativos_por_municipio_new
