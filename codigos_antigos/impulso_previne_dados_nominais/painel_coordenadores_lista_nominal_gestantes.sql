...
-- impulso_previne_dados_nominais.painel_coordenadores_lista_nominal_gestantes source
...
AS WITH dados_anonimizados_demo_vicosa AS (
 ...
 SELECT tabela_aux.municipio_id_sus,
    ...
    tabela_aux.acs_nome,
    tabela_aux.acs_data_ultima_visita,
    tabela_aux.gestante_documento_cpf,
    tabela_aux.gestante_documento_cns,
    tabela_aux.gestante_nome,
    tabela_aux.gestante_data_de_nascimento,
    tabela_aux.gestante_telefone,
    tabela_aux.gestante_endereco,
    tabela_aux.gestante_dum,
    tabela_aux.gestante_idade_gestacional_atual,
    tabela_aux.gestante_idade_gestacional_primeiro_atendimento,
    tabela_aux.gestante_dpp,
    tabela_aux.gestante_quadrimestre,
    tabela_aux.gestante_consulta_prenatal_data_limite,
    tabela_aux.gestacao_dpp_dias_para,
    tabela_aux.gestante_consulta_prenatal_total,
    tabela_aux.gestantes_com_6_consultas,
    tabela_aux.gestante_consulta_prenatal_ultima_data,
    tabela_aux.gestante_consulta_prenatal_ultima_dias_desde,
    tabela_aux.atendimento_odontologico_realizado,
    tabela_aux.atendimento_odontologico_realizado_identificacao,
    tabela_aux.exame_hiv_realizado,
    tabela_aux.exame_sifilis_realizado,
    tabela_aux.exame_sifilis_hiv_realizado,
    tabela_aux.exame_sifilis_hiv_realizado_identificacao,
    tabela_aux.possui_registro_aborto,
    tabela_aux.possui_registro_parto,
